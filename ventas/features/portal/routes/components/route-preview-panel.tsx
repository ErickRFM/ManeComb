      ...
      {selectedSavedRoute ? (
        <View style={styles.mapActionBar}>
          ...
          <View style={styles.mapStats}>
            ...
            <View><Text style={styles.statValue}>{selectedSavedRoute.stops.length}</Text><Text style={styles.statLabel}>Checkpoints</Text></View>
          ...
          <View style={styles.mapActions}>
            <PortalButton onPress={onEditRoute} size="sm" variant="secondary">Editar</PortalButton>
            <PortalButton disabled={!canAssign} loading={isAssigning} onPress={onAssignRoute} size="sm">Asignar ruta</PortalButton>
          </View>
        </View>
      ) : null}
    </>
