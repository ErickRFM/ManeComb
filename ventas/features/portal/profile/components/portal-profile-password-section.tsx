...
export function PortalProfilePasswordSection({ onChanged }: { onChanged: () => void }) {
  ...
  return (
    <PortalSectionCard
      ...
      subtitle="Confirma tu contraseña actual. Al guardar, las demás sesiones se cerrarán por seguridad.">
      <View style={styles.securityHeader}>
        <View style={styles.securityIcon}>
          <MaterialCommunityIcons name="shield-lock-outline" size={22} color={portalPalette.accent} />
        </View>
        <View style={styles.securityCopy}>
          <Text style={styles.securityTitle}>Protección de acceso</Text>
          <Text style={styles.securityText}>
            ManeComb nunca mostrará tu contraseña. Usa una clave exclusiva y evita reutilizarla en otros servicios.
          </Text>
        </View>
        <Pressable
