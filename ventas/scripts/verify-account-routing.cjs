...
console.log('Canonical channels, capabilities, route registry, scoped boot, product boundaries, checkout intent, provider readiness and trial/demo → Portal verified.');
