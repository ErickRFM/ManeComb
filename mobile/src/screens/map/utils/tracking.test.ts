import {
  makeOperationalUnitSnapshot,
  type OperationalUnitSnapshotOverrides,
} from '@/src/test-utils/operational-snapshot';
import {
  getActiveRouteCount,
  getMappableUnits,
...
function unit(overrides: OperationalUnitSnapshotOverrides = {}) {
