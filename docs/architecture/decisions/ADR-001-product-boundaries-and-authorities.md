...
- **Fecha:** 2026-08-06
- **Base:** `main@06909cca6814441386f7be25e6e5d5a0e9c636f8`
...
El commit base ya integra la limpieza de demo, la igualdad de tarjetas y la continuidad de compra. Esos cambios se preservan. La siguiente mejora no corregirá síntomas aislados: establecerá quién tiene la última palabra sobre cada decisión.
